...
from tools.data_for_generators import (UA_NORMAL, UA_TOOLS, UA_BOTS, PUBLIC_PAGE_PATHS, 
                   CATALOG_PATHS, API_READ_PATHS, STATIC_PATHS, 
                   AUTH_FLOW_PATHS, BENIGN_EDGE_PATHS, LOGIN_PATHS,
                   SCAN_WORDLIST, SQLI_PAYLOADS, XSS_PAYLOADS,
                   LFI_PAYLOADS)
